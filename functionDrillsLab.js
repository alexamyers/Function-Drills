...
let nameGreeting = nameCheck("Shane")
...
console.log(bestMovie("Forrest Gump"))
...
let roundOneWinners = theEliminator(contestants, loser) 
...
console.log(emailCheck("alex@yahoo.com"))
...
function potOfFrogs(goldAmount) {
if (goldAmount % 3 === 0) {
  return (goldAmount / 3)
} else return (Math.floor(goldAmount / 3))
}

let totalFrogs = potOfFrogs(67)
...
let arrayIsAscending = ascension(sampleArray2)
